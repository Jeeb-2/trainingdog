(function ($) {
  ...
  if ($(".accrodion-grp").length) {
    $(".accrodion-grp").each(function () {
      ...
      function openTab(tabId) {
        ...
        $(tabId).find(".accrodion-content").slideDown();
      }

      var tabIdFromURL = window.location.hash;
      if (tabIdFromURL) {
        openTab(tabIdFromURL);
      }
  ...
  if ($(".main-header .outer-box .nav-btn").length) {
    ...
    //Hide Form
    $(".appointment-box .inner-box .cross-icon,.form-back-drop").on(
      "click",
      function (e) {
        e.preventDefault();
  ...
  if ($(".lightbox-image").length) {
    $(".lightbox-image").fancybox({
      openEffect: "fade",
      closeEffect: "fade",
      buttons: ["slideShow", "fullScreen", "share", "close"],
      helpers: {
        media: {},
      },
    });
...
$(document).ready(function () {
  ...
  $(".pet.tm_profile .profile .images+.card ul li.links a").addClass(
    "hvr-radial-in"
  );

  // Blog Profile

  $(".pet.b_profile .job .profile .elements span.share a").addClass(
    "hvr-radial-in"
  );
  ...
  if ($(window).width() < 768) {
    ...
    $(
      ".about.pet .about_us .image .an_image, .about.second .about_us .image .an_image"
    ).removeClass("an_image_vt_ps_middle");
    $(
      ".about.pet .about_us .image .an_image, .about.second .about_us .image .an_image"
    ).addClass("an_image_vt_ps_bottom");
